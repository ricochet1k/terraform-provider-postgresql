		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "columns.0.type", "INT4"),
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "columns.1.name", "b"),
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "columns.1.type", "TEXT"),
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "rows.#", "1"),
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "rows.0.a", "1"),
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "rows.0.b", "2"),
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "columns.#", "1"),
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "columns.0.name", "val"),
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "columns.0.type", "TEXT"),
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "rows.#", "2"),
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "rows.0.val", "foo"),
					resource.TestCheckResourceAttr("data.postgresql_query.test_schema", "rows.1.val", "bar"),
				),
			},
		},
	})
