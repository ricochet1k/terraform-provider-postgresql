		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.postgresql_tables.test_schema", "tables.0.table_name", "test_table"),
					...
					resource.TestCheckResourceAttr("data.postgresql_tables.test_schemas_not_like_all_table1and2", "tables.0.table_name", "test_table"),
					...
					resource.TestCheckResourceAttr("data.postgresql_tables.test_schemas_combine_filtering", "tables.0.table_name", "test_table2"),
